...
const Bio = () => {
    ...
    return (
        ...
        <div data-modal-target="medium-modal" data-modal-toggle="authentication-modal" className="  bg-gray-100 min-h-screen p-4 flex flex-col items-center justify-center">
            ...
            <div className="  w-2/4 h-2/4 border-2 border-black-300 bg-gray-200 rounded-md p-4 flex flex-col items-center justify-center">
                ...
                <div className="w-full bg-white rounded-md p-6 border-2 border-slate-800 drop-shadow-md shadow-md">
                    ...
                    <form onSubmit={handleSubmit} data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
